...
/* A snippet patched into tb_htable_lookup to inform the parent process that
...
#define AFL_QEMU_CPU_SNIPPET2(cpu, pc) do { \
...
const char *aflLogFile = "/tmp/work.log";
...
void afl_setup(void) {
  ...
  // TODO: rcu_disable_atfork was added in 2.10.0-rc2. Uncomment the following
  // line when merging with 2.10
  //rcu_disable_atfork();
